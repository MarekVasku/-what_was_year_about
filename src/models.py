...
class DashboardData:
    ...
    def to_tuple(self) -> tuple:
        ...
        return (
            ...
            self.all_songs_table if self.all_songs_table is not None and not self.all_songs_table.empty else pd.DataFrame(),
            self.user_comparison_table if self.user_comparison_table is not None and not self.user_comparison_table.empty else pd.DataFrame(),
