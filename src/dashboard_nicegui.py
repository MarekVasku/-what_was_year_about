...
def build_nicegui_dashboard() -> None:
    ...
    df_raw, avg_scores, total_votes, avg_of_avgs, total_songs, error = get_data_cached()
    ...
    ui.table(records, columns=[{'name': 'Rank', 'label': 'Rank'}, {'name': 'Song', 'label': 'Song'}, {'name': 'Average Score', 'label': 'Average Score'}])
